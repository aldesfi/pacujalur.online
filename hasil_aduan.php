...
<button id="aktif_lidi" onclick="window.location.href='index.php'" class="btn-download">Kembali</button>
...
<button id="aktif_lidi" onclick="window.location.href='index.php'" class="btn-download">Hari Ini</button>
<button id="hasil.php" onclick="window.location.href='hasil.php'" class="btn-download">Hasil</button>
  ...
  <li>Total: <span class="asal" id="totalAsal">~</span></li>
    ...
    <script src="scriptku2.js"></script>
